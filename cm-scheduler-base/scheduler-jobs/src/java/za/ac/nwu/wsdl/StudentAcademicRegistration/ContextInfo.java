...
public class ContextInfo  implements java.io.Serializable {
    ...
    private za.ac.nwu.wsdl.StudentAcademicRegistration.AttributeInfo[] attributes;
    ...
    public ContextInfo(
           ...
           za.ac.nwu.wsdl.StudentAcademicRegistration.AttributeInfo[] attributes) {
     ...
     * @return attributes
     */
    public za.ac.nwu.wsdl.StudentAcademicRegistration.AttributeInfo[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(za.ac.nwu.wsdl.StudentAcademicRegistration.AttributeInfo[] attributes) {
        this.attributes = attributes;
    }

    public za.ac.nwu.wsdl.StudentAcademicRegistration.AttributeInfo getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, za.ac.nwu.wsdl.StudentAcademicRegistration.AttributeInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://nwu.ac.za/wsdl/StudentAcademicRegistration", "ContextInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://nwu.ac.za/wsdl/StudentAcademicRegistration", "AttributeInfo"));
